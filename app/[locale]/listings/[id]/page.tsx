  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20 lg:pb-0">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        <button
          onClick={() => router.back()}
          className="mb-4 sm:mb-6 text-brand-primary hover:text-brand-secondary flex items-center gap-2 font-medium transition-colors group text-sm sm:text-base no-print"
        >
              ...
              <div className="flex flex-col gap-3 mb-6 no-print">
                ...
                {(listing.contactPhone || userProfile?.phone) && (
                  <a
                    ...
                    className="w-full px-6 py-3 bg-brand-primary text-white rounded-xl font-semibold hover:bg-brand-secondary transition-all hover:shadow-lg text-base flex items-center justify-center gap-2"
                    >
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              {(listing.contactPhone || userProfile?.phone) && (
                <a
                  href={`tel:${(listing.contactPhone || userProfile?.phone)?.replace(/[^0-9+]/g, '')}`}
                  className="flex items-center justify-center w-12 h-12 bg-brand-primary text-white rounded-full hover:bg-brand-secondary transition-all shadow-lg"
                  aria-label="Call"
                >
